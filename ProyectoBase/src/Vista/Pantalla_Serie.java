...
public class Pantalla_Serie extends JFrame {
	

	private JPanel contentPantallaSerie;
	...
	public Pantalla_Serie() {
		...
		contentPantallaSerie = new JPanel();
		contentPantallaSerie.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(contentPantallaSerie);
		
		panelSerie = new JPanel();
		panelSerie.setBorder(new EtchedBorder(EtchedBorder.LOWERED, null, null));
		...
		GroupLayout gl_contentPantallaPelicula = new GroupLayout(contentPantallaSerie);
			...
			gl_contentPantallaPelicula.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPantallaPelicula.createSequentialGroup()
					...
					.addGroup(gl_contentPantallaPelicula.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(panelSerie, GroupLayout.DEFAULT_SIZE, 185, Short.MAX_VALUE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_contentPantallaPelicula.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPantallaPelicula.createSequentialGroup()
			...
			gl_contentPantallaPelicula.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPantallaPelicula.createSequentialGroup()
					...
					.addGroup(gl_contentPantallaPelicula.createParallelGroup(Alignment.LEADING, false)
						.addComponent(panelSerie, 0, 0, Short.MAX_VALUE)
		...
		GroupLayout gl_panelPelicula = new GroupLayout(panelSerie);
		...
		panelSerie.setLayout(gl_panelPelicula);
		contentPantallaSerie.setLayout(gl_contentPantallaPelicula);
	}
}
