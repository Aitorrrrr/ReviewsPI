...
public class Pantalla_Serie_Admin extends JFrame {

	private JPanel contentPane;
	private JPanel ImagenSerie;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Pantalla_Pelicula_Admin frame = new Pantalla_Pelicula_Admin();
	...
	public Pantalla_Serie_Admin() {
		...
		textNombreUsuario.setText("Nombre de Admin");
		...
		ImagenSerie = new JPanel();
		ImagenSerie.setBorder(new EtchedBorder(EtchedBorder.LOWERED, Color.BLACK, null));
		ImagenSerie.setBounds(10, 31, 159, 232);
		contentPane.add(ImagenSerie);
		...
		buttonValorar.setFont(new Font("Tahoma", Font.PLAIN, 16));
		...
		buttonOpcionesAdmin = new JButton("Opciones de Admin");
		buttonOpcionesAdmin.setFont(new Font("Tahoma", Font.PLAIN, 14));
		buttonOpcionesAdmin.setBounds(10, 544, 159, 32);
		contentPane.add(buttonOpcionesAdmin);
	}
}
